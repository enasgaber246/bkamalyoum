                  ...
                  InputDataWidget(
                    ...
                    onChanged: (value) {
                      ...
                      if (dropDownTypeBuySell.dropdownvalue.index == 0) {
                        ...
                        // Selling
                        price = (double.parse(
                                dropDownCurrency.dropdownvalue.sellingPrice) ??
                            0);
                      }

                      double enteredValue = double.parse(value) ?? 0;
                      double percentageValue = enteredValue / price;

                      print('percentageValue :  ${percentageValue}');
                      changePercentageCtrl.text = percentageValue.toString();
                    },
                  ),
                  SizedBox(height: 110.0.sp),
